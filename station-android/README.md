...
- **Web ↔ native bridge:**
  ...
  - Startup: on cold start the hosting shell shows a station splash (UA `ShowrunnerStation`) instead of the personal-phone UI, cleared when the shell posts `SHOWRUNNER_STATION_READY`.
