...
**Arrange UI mirror (2026-07-31 / v751–v754):** Ledger remains SoT. Live fixtures must carry camelCase truck fields after warm arrange. **v754:** Auto-cases often missing from Firebase PA — Arrange now emits ledger legs for unmatched `paUid`s, upserts minimal auto PA docs, merges autos on save success, and delta state rebuild re-overlays logistics. **Exit badge (R3e):** batch Arrange + Hub commits before campaign close.
