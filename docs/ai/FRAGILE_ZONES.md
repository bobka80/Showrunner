...
**Goal:** Gun EPC reaches station live strip and host/vault flows — **Chainway APK** and **TSL desktop** use different native delivery but the **same station core logic** (`11c`–`11i` modules; see [STATION_UI.md](STATION_UI.md)).
