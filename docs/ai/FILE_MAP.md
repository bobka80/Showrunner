...
| `push-hosting/public/mobile-scan.html` | Same-origin PWA camera page (Android/HyperOS). Scan → `sessionStorage sm_mobile_qr_pending` → return to `/`; host-boot flushes into iframe. |
