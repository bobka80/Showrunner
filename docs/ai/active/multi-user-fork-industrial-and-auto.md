...
**Opened:** 2026-07-18 · **Status:** **Active** — **A5/H3 done** @ GAS **v670** + `host-boot.js?v=665`; next **A6/H2**. Prior: **A0 + H1 + H5 + Gap 1 + H4**.  
**Production / prep live rollback:** GAS **v656** · hosting `host-boot.js?v=655` · sync baseline **v654** · Prep banner **`live sync (patch)`**  
**Latest:** Visible peer-delete conflict cue after dept move **v670**.  
