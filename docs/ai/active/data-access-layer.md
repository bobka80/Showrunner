...
**Opened:** 2026-07-05 · **Status:** Prep multi-user live **rollback = GAS v654** + `host-boot.js?v=653` (director-confirmed sync rework). Docs: floor scope on [multi-user-fork](multi-user-fork-industrial-and-auto.md). **Next campaign work:** Gap 1 (A3) on that hub (H5 done). How it works: [FRAGILE § session UI](../FRAGILE_ZONES.md) · [dal-prep-live-sync-standards.md](dal-prep-live-sync-standards.md). **DAL-era catastrophic rollback:** **v576**.
