...
**Opened:** 2026-07-05 · **Status:** Live PA/timeline forks; prep PA live sync must match timeline touch/`writeSeq` discipline — see [dal-pa-live-sync-thrash.md](dal-pa-live-sync-thrash.md). **Production:** GAS shipping next. **Rollback baseline:** GAS **v576**.
