...
**Opened:** 2026-07-05 · **Status:** Live PA/timeline forks; timeline + **prep PA** live sync via **host shell** Firebase. **Production:** GAS **v626** + hosting (prep host collection listen ships next). **Rollback baseline:** GAS **v576**.
