...
**Opened:** 2026-07-05 · **Status:** Prep multi-user live **production = GAS v655** (H5); sync rework rollback **v654** + `host-boot.js?v=653`. Docs: floor scope on [multi-user-fork](multi-user-fork-industrial-and-auto.md). **Next campaign work:** **A4 / H4** (state size + END mirror) on that hub (Gap 1/A3 done). How it works: [FRAGILE § session UI](../FRAGILE_ZONES.md) · [dal-prep-live-sync-standards.md](dal-prep-live-sync-standards.md). **DAL-era catastrophic rollback:** **v576**.
