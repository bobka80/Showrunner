...
**Opened:** 2026-07-05 · **Status:** Live PA/timeline forks; timeline + **prep PA** live sync via **host shell** Firebase. **Production:** GAS **v627** + hosting (`host-boot.js?v=627`). **Rollback baseline:** GAS **v576**.
