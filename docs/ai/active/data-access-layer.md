...
**Opened:** 2026-07-05 · **Status:** Live PA/timeline forks; prep delete/seed fix **v639** — [dal-pa-delete-resurrect.md](dal-pa-delete-resurrect.md) (await director smoke). **Prep live doctrine:** [dal-prep-live-sync-standards.md](dal-prep-live-sync-standards.md). Prior thrash: [dal-pa-live-sync-thrash.md](dal-pa-live-sync-thrash.md). Hosting still `host-boot.js?v=635`. **Rollback baseline:** GAS **v576**.
