...
**Opened:** 2026-07-05 · **Status:** **Direct client Firebase writes** for live PA/timeline forks (GAS only for open/close/commit). **Production:** GAS **v613+** (ship bumps). **Rollback baseline:** GAS **v576**.
