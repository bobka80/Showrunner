...
**Planned DAL live-sync gates (Gap 1 shipped with Part A):** sync-mode lint — [dal-pre-ship-gates.md](archive/dal-pre-ship-gates.md) · hub [multi-user-fork](archive/multi-user-fork-industrial-and-auto.md) (archived).
