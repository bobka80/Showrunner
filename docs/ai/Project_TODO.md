...
| Timeline collab session | Partial — Phase A + live sync + thrash fix; **optional post-campaign:** auto-room + idle commit | [topics/timeline-collab-session.md](topics/timeline-collab-session.md) |
