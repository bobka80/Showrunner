...
**Primary campaign (NEXT):** **Logistics Ledger** — **live forks paused** (Sheets-only); next **M2 backfill**. — [active/logistics-ledger-2026-07-21.md](active/logistics-ledger-2026-07-21.md).
...
| Item | Status | File |
|------|--------|------|
| **Logistics Ledger** | **Forks paused** — Sheets-only; then M2 | [active/logistics-ledger-2026-07-21.md](active/logistics-ledger-2026-07-21.md) |
...
|----------|--------|------|
| **Logistics Ledger** (movement SoT + PA slim) | **Forks paused** — Sheets-only; then M2 | [active/logistics-ledger-2026-07-21.md](active/logistics-ledger-2026-07-21.md) · [pack](topics/architecture-multi-campaign-pack-2026-07-21.md) · [schema](topics/logistics-ledger-schema-2026-07-20.md) |
