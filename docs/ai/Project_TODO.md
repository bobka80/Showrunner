...
| **A3–A6** | Gap 1 → H4 → H3 → H2 | **A3 done → next A4/H4** |
...
|----------|--------|------|
| **Multi-user fork: test pipeline → bulletproof → auto fork** | **Active** — **A3 Gap 1 done**; next **A4/H4** | [active/multi-user-fork-industrial-and-auto.md](active/multi-user-fork-industrial-and-auto.md) · [bulletproof](active/bulletproof-multiuser-live-editors-2026-07-18.md) |
