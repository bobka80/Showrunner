...
**Last swept:** 2026-07-02 · **Production:** GAS **v419** · **Status:** Partial — RFID checkout bar, station shell + configurable host auto-eject + live scan strip + self-serve badge enrollment + station setup view (power/mode/speed/beeper) with **direct native bridge + live apply**, iframe scan-bridge fix, native gun app + APK install page shipped; gate + PA concurrency backlog planned
