...
| Logistics & warehouse RFID | Partial — checkout bar + backend | [logistics-warehouse.md](logistics-warehouse.md) |
...
| UX & platform | Backlog (nothing shipped) | [ux-platform.md](ux-platform.md) |
...
When adding a new area: create a topic file here, add one line to `Project_TODO.md` index.
