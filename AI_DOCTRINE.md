...
| Station gun scans, `RfidManager`, `showrunnerStationDeliverScan`, station UI split | [FRAGILE_ZONES.md](docs/ai/FRAGILE_ZONES.md) § Two-layer shell bridge + § Station RFID · [STATION_UI.md](docs/ai/STATION_UI.md) |
