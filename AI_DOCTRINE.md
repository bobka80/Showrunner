...
| Multi-user fork harden / auto fork (prep + timeline) | **Archived** [archive/multi-user-fork-industrial-and-auto.md](docs/ai/archive/multi-user-fork-industrial-and-auto.md) · process [archive/bulletproof-multiuser-live-editors-2026-07-18.md](docs/ai/archive/bulletproof-multiuser-live-editors-2026-07-18.md) · UX: [topics/timeline-collab-session.md](docs/ai/topics/timeline-collab-session.md) § Optional update |
| Logistics Ledger / PA truck migration / Campaign Room sequencing | [active/logistics-ledger-2026-07-21.md](docs/ai/active/logistics-ledger-2026-07-21.md) · pack [topics/architecture-multi-campaign-pack-2026-07-21.md](docs/ai/topics/architecture-multi-campaign-pack-2026-07-21.md) · schema [topics/logistics-ledger-schema-2026-07-20.md](docs/ai/topics/logistics-ledger-schema-2026-07-20.md) · locks [topics/architecture-campaign-director-locks-2026-07-21.md](docs/ai/topics/architecture-campaign-director-locks-2026-07-21.md) · **terms:** [GLOSSARY.md](docs/ai/GLOSSARY.md) § sub-events vs phases |
| Timeline collab / phases vs sub-events | [topics/timeline-collab-session.md](docs/ai/topics/timeline-collab-session.md) · [GLOSSARY.md](docs/ai/GLOSSARY.md) § Timeline |
...
| Prep PA multi-user live sync (batch add, pack, delete/resurrect, START/END banner) | [archive/multi-user-fork-industrial-and-auto.md](docs/ai/archive/multi-user-fork-industrial-and-auto.md) § floor scope → [archive/dal-prep-live-sync-standards.md](docs/ai/archive/dal-prep-live-sync-standards.md) → [FRAGILE_ZONES.md](docs/ai/FRAGILE_ZONES.md) § prep PA fork live sync · open incident if any |
