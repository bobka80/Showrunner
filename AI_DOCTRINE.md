...
| DAL, Firebase session fork, data router | [topics/dal-live-forks-pause.md](docs/ai/topics/dal-live-forks-pause.md) **(check CURRENT pause first)** → [topics/session-fork-platform.md](docs/ai/topics/session-fork-platform.md) → [archive/dal-firebase-design-lock-2026-07-13.md](docs/ai/archive/dal-firebase-design-lock-2026-07-13.md) → [archive/data-access-layer.md](docs/ai/archive/data-access-layer.md) → [archive/dal-pre-ship-gates.md](docs/ai/archive/dal-pre-ship-gates.md) · lasting: [topics/data-cache-engine.md](docs/ai/topics/data-cache-engine.md) · **session banners / dual-domain UI:** [FRAGILE_ZONES.md](docs/ai/FRAGILE_ZONES.md) § DAL prep/timeline session UI |
| Multi-user fork harden / auto fork (prep + timeline) | **Archived** [archive/multi-user-fork-industrial-and-auto.md](docs/ai/archive/multi-user-fork-industrial-and-auto.md) · process [archive/bulletproof-multiuser-live-editors-2026-07-18.md](docs/ai/archive/bulletproof-multiuser-live-editors-2026-07-18.md) · UX: [topics/timeline-collab-session.md](docs/ai/topics/timeline-collab-session.md) § Optional update · **pause ops:** [topics/dal-live-forks-pause.md](docs/ai/topics/dal-live-forks-pause.md) |
| Logistics Ledger / PA truck migration / Campaign Room sequencing | Ledger [archive/logistics-ledger-2026-07-21.md](docs/ai/archive/logistics-ledger-2026-07-21.md) · **Room COMPLETE** [archive/project-campaign-room-2026-07-24.md](docs/ai/archive/project-campaign-room-2026-07-24.md) · **Warm readers COMPLETE** [archive/warm-readers-offer-tracker-2026-08-05.md](docs/ai/archive/warm-readers-offer-tracker-2026-08-05.md) · **Warm Live ACTIVE** [active/warm-live-completion-2026-08-11.md](docs/ai/active/warm-live-completion-2026-08-11.md) · pack [topics/architecture-multi-campaign-pack-2026-07-21.md](docs/ai/topics/architecture-multi-campaign-pack-2026-07-21.md) · schema [topics/logistics-ledger-schema-2026-07-20.md](docs/ai/topics/logistics-ledger-schema-2026-07-20.md) · locks [topics/architecture-campaign-director-locks-2026-07-21.md](docs/ai/topics/architecture-campaign-director-locks-2026-07-21.md) · **forks:** [topics/dal-live-forks-pause.md](docs/ai/topics/dal-live-forks-pause.md) · **terms:** [GLOSSARY.md](docs/ai/GLOSSARY.md) § sub-events vs phases |
| Timeline collab / phases vs sub-events | [topics/timeline-collab-session.md](docs/ai/topics/timeline-collab-session.md) · [GLOSSARY.md](docs/ai/GLOSSARY.md) § Timeline · **pause:** [topics/dal-live-forks-pause.md](docs/ai/topics/dal-live-forks-pause.md) |
...
| Prep PA multi-user live sync (batch add, pack, delete/resurrect, START/END banner) | [topics/dal-live-forks-pause.md](docs/ai/topics/dal-live-forks-pause.md) **(if paused, stop — Sheets path only)** → [archive/multi-user-fork-industrial-and-auto.md](docs/ai/archive/multi-user-fork-industrial-and-auto.md) § floor scope → [archive/dal-prep-live-sync-standards.md](docs/ai/archive/dal-prep-live-sync-standards.md) → [FRAGILE_ZONES.md](docs/ai/FRAGILE_ZONES.md) § prep PA fork live sync · open incident if any |
...
6. **Plain-Language Handoff After Fixes:** After every completed build / ship (or a finished docs-only session that advances a campaign), end the reply with **all** of the following, in order:
   ...
   4. **This turn (simple words)** — mandatory closing block for **update campaigns** and any session that moves campaign work forward. Write for a non-developer. No jargon dump. After testing instructions, always say:
      - **What I just did** — one or two short sentences about this reply (e.g. “I fixed the freeze after End Prep” / “I only updated the campaign docs — no app code”).
      - **What I updated** — concrete list in plain language (app files / docs / GAS version if shipped). If nothing shipped, say so.
      - **Next slice** — the single recommended next piece of work to OK go, in everyday words (pull from the active campaign checklist). Same campaign only — do not invent a new campaign or jump ahead unless the director asked.
   5. **Campaign next (checklist)** — optional short leftover list if helpful; the **Next slice** line in (4) is the one the director acts on.
