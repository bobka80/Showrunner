...
| Prep PA multi-user live sync (qty thrash, delete/resurrect, START/END banner) | [active/dal-prep-live-sync-standards.md](docs/ai/active/dal-prep-live-sync-standards.md) → [FRAGILE_ZONES.md](docs/ai/FRAGILE_ZONES.md) § prep PA fork live sync · open incident if any |
